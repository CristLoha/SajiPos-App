...
class OngkirDialog extends StatelessWidget {
  const OngkirDialog({super.key});
          ...
          builder: (context, costState) {
            ...
            return BlocBuilder<CartCubit, CartState>(
              builder: (context, cartState) {
                final currentFee = cartState.shippingFeeAmount;
                ...
                return Column(
                  ...
                  children: [
                    ...
                    if (defaultFee > 0)
                      _buildOption(
                        ...
                        onChanged: () {
                          context.read<CartCubit>().updateCosts(
                            shippingFeeAmount: isSelected ? 0.0 : defaultFee,
                          );
                        },
                      )
                    else
                      const Center(
                        child: Text(
                          'Ongkos kirim belum diatur di Pengaturan',
