  ...
  Future<List<DiscountModel>> getActiveDiscounts(String token) async {
    try {
      ...
      if (response.statusCode == 200) {
        return DiscountResponse.fromJson(response.data as Map<String, dynamic>).discountList;
      } else {
        throw ServerException(response.statusMessage ?? 'Gagal memuat data diskon');
      }
